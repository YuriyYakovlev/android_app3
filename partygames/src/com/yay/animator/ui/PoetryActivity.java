...
public class PoetryActivity extends AdActivity implements AsyncQueryListener, DialogInterface.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null) {
        	...
        	if(getIntent().hasCategory(Intent.CATEGORY_TAB)) {
        		mHandler.startQuery(PoetryQuery._TOKEN, Poetry.buildSearchUri(extras.getString("query")), PoetryQuery.PROJECTION, Poetry.DEFAULT_SORT);
        	} else {
        		int starred = extras.getInt(PoetryColumns.STARRED.getName());
        		if(starred == 1) {
        			((TextView) findViewById(R.id.title_text)).setText(getResources().getString(R.string.starred) + "/" + getResources().getString(R.string.poetry));
	        		((ImageButton) findViewById(R.id.title_delete)).setVisibility(View.VISIBLE);
	        		mHandler.startQuery(PoetryQuery._TOKEN, Poetry.buildStarredUri(), PoetryQuery.PROJECTION, Poetry.DEFAULT_SORT);
	       		} else {
            ...
            progressDialog = CustomProgressDialog.show(PoetryActivity.this, null, null);
        }
    }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
    	if(mAdapter != null) {
	    	...
	    	intent.putExtra(Config.PARAM_ID, cursor.getInt(PoetryQuery._ID));
	    	intent.putExtra(Config.PARAM_IDP, idp);
	    	intent.putExtra(Config.PARAM_TYPE, Config.POETRY);
    ...
    public void onClick(DialogInterface arg0, int arg1) {
        if(mAdapter != null && mAdapter.getCursor() != null) {
        	final ContentValues values = new ContentValues();
   	     	values.put(PoetryColumns.STARRED.getName(), 0);
   	     	mHandler.startUpdate(Poetry.buildStarredUri(), values);
    ...
    public void onQueryComplete(int token, Object cookie, Cursor cursor) {
    	 if(PoetryQuery._TOKEN == token && mAdapter != null && cursor != null) {
    ...
    private class PoetryAdapter extends CursorAdapter /*implements SectionIndexer*/ {
    	//AlphabetIndexer alphaIndexer;
    	
    	public PoetryAdapter(Context context) {
            super(context, null);
            //alphaIndexer=new AlphabetIndexer(null, PoetryQuery.NAME, getResources().getString(R.string
            // .alpha_indexer));
        }
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            String name = cursor.getString(PoetryQuery.NAME);
